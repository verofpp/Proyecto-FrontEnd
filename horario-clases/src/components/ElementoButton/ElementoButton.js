    ...
    return (
        <div className='elemento-container'>
            <div className='codigo-container'>
                <p className='codigo-materia'>{ props.codigo }</p>
            </div>
            <Link
                style={{ backgroundColor: color }}
                className='materia-button'
                onMouseEnter={() => setColor('#DACDED')}
                onMouseLeave={() => setColor('#EADDFF')}
                onMouseDown={() => setColor('#D1C6E4')}
                to={ props.link }
            >
                <p className='materia-nombre'>{ props.nombre }</p>
                <span className='materia-secciones'>{ props.span }</span>
            </Link>
